...
import { i as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, r as renderTemplate, u as unescapeHTML, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, b as renderComponent, A as AstroUserError } from './astro/server_C8gyeDor.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_WO2zTkgp.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_QLKEFhfe.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_D1NkeRlS.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Cpl5tmcu.mjs');
...
const project = {"build":{"format":"directory"},"root":"file:///F:/IT%20projects/starlight-website/","srcDir":"file:///F:/IT%20projects/starlight-website/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, DeprecatedLabelsPropProxy as D, VALID_SUPPORTED_FORMATS as V, getCollectionPathFromRoot as a, getCollection as b, stripTrailingSlash as c, stripLeadingSlash as d, stripHtmlExtension as e, ensureHtmlExtension as f, getEntry as g, ensureTrailingSlash as h, pickLang as i, stripLeadingAndTrailingSlashes as j, ensureLeadingSlash as k, stripExtension as l, DEFAULT_OUTPUT_FORMAT as m, DEFAULT_HASH_PROPS as n, getCollectionPath as o, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
